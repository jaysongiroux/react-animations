...
class InLinePopup extends _react.Component {
  ...
  render() {
    if (this.props.show) {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        className: "inlinepopupContainer ".concat(this.props.variant, " ").concat(this.props.size, " ").concat(this.props.animated ? "animated" : null)
      }, this.getVariantIcon());
    }
